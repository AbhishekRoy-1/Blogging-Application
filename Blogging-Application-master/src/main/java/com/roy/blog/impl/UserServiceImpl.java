...
import com.roy.blog.exceptions.*;
...
//		user.setName(userDto.getName());
//		user.setEmail(userDto.getEmail());
//		user.setPassword(userDto.getPassword());-----> Instead of manually converting userDto to user we have used ModelMapper injection from maven which directly maps ours models.
//		user.setAbout(userDto.getAbout());
//		
		return user;
